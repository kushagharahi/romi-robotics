...
public class RobotContainer {
  ...
  private final DriveForward driveForward = new DriveForward(.5, 10000, m_romiDrivetrain);
  
  private final DriveDistance driveDistance = new DriveDistance(.5, m_romiDrivetrain, 12);
